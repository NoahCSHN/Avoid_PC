...
f1=VOCtest_06-Nov-2007.tar # 446MB, 5012 images
cp ../datasets_zip/$f1 ./$f1

for f in $f1; do
  echo 'Downloading' $url$f '...' 
#   curl -L $url$f -o $f && unzip -q $f -d $d && rm $f & # download, unzip, remove in background
  tar -xf $f -C $d && rm $f & # download, unzip, remove in background
done
...
import shutil
import os
os.system('mkdir ../VOC_test/')
os.system('mkdir ../VOC_test/images')
os.system('mkdir ../VOC_test/images/test')
# os.system('mkdir ../VOC/images/val')

os.system('mkdir ../VOC_test/labels')
os.system('mkdir ../VOC_test/labels/test')
...
for line in lines:
    ...
    if (os.path.exists("../" + line)):
        os.system("cp ../"+ line + " ../VOC_test/images/test")
        
    line = line.replace('JPEGImages', 'labels')
    line = line.replace('jpg', 'txt')
    if (os.path.exists("../" + line)):
        os.system("cp ../"+ line + " ../VOC_test/labels/test")
